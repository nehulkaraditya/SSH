    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            */
            ...
            //Below Code is Added by Swpanil 
            
            // Create Security Group for Instance
            
             String GroupName = "GrpAws6"; 
             CreateSecurityGroupRequest GroupRequest = new CreateSecurityGroupRequest(GroupName, "AWS group");
            ...
            try {
    			...
    			String content = keyPair.getKeyMaterial();
    			 ...
    			 String fileName="C:\\Users\\swap\\Downloads\\"+"AWS_KEY"+".pem"; 
 ...
 class SSHAgent1 {
    ...
    public boolean connect() throws Exception
    {
        try
        {
            ...
            File file = new File("C:\\Users\\swap\\Downloads\\AWS_KEY.pem");
